...
function loadPage()
{
	 ...
	 //  var status = doLMSGetValue( "cmi.core.lesson_status" );
	   ...
	   myscore = doLMSGetValue("cmi.core.score.raw");
	   currentProgress = doLMSGetValue("cmi.core.lesson_progress");
	   //alert("lesson_status:"+status);
	   ...
	   }else if(status=="incomplete"&&currentstatus=="completed"){
		   doLMSSetValue( "cmi.core.lesson_status", "completed" );
